...
const CreateDueForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await post('/dues', dueData);

      if (response.success) {
        setSuccessMessage('Due created successfully!');
        // Reset form
        setFormData({
          name: '',
          description: '',
      ...
      setError(err.message || 'An error occurred while creating the due');
    } finally {
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold text-gray-900">Create New Due</h1>
          <p className="mt-2 text-sm text-gray-700">
            Create a new due for members by filling out the form below.
          </p>
        </div>
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    rows={3}
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    placeholder="Monthly membership fee for April 2025"
                  />
                </div>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      If checked, this due will be applied to all active members.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-end">
              ...
              >
                {isSubmitting ? 'Creating...' : 'Create Due'}
              </button>
            </div>
          </form>
        </div>
